      ...
      <div class="row">
                    ...
                    <tbody>
                      <?php if(!empty($customRatings)) { ?>
                          <?php foreach($customRatings as $rating){?>
                              <tr>
                                  <td class="sorthandle"><input type="hidden" name="raID[]" value="<?= $rating->getID(); ?>"><input type="hidden" name="raStandard[]" value="0"><i class="fa fa-arrows-v"></i></td>
          ...
          <div class="col-sm-9 store-pane" id="settings-reviews-statuses">
            ...
            <?php
                ...
                echo t("No Review Statuses are available");
            }
            ?>
          </div>
