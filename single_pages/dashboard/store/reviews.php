    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <?php if(!empty($ratings)) { ?>
                    <?php foreach($ratings as $name => $value) { ?>
                        <h4><?= t($name); ?></h4>
        ...
        <div class="col-sm-4">
            ...
            <?php if(!empty($product)) { ?>
                ...
                <p>
                    <?php $imgObj = $product->getImageObj(); ?>
                    <?php if (is_object($imgObj)) { ?>
                        <?php $thumb = Core::make('helper/image')->getThumbnail($imgObj, 300, 300, true); ?>
                ...
                <p>
                    <a href="<?= URL::to('/dashboard/store/products/edit/', $product->getID()); ?>" class="btn btn-primary">
                        <?= t('View Product'); ?>
                    </a>
                </p>
              <?php } ?>
                        ...
                        <?php if($userApprove) { ?>
                            <td data-column="actions">
                                <?php if($statusHandle == "pending") { ?>
                                    <a href="" data-status-handle="approved" data-review="<?= $review->getID()?>"
                                       class="btn btn-success store-dashboard-review-status"
                                       title="<?= t('Approve'); ?>">
                                        <i class="fa fa-check"></i>
                                    </a>
                                    <a href="" data-status-handle="not_approved" data-review="<?= $review->getID()?>"
                                       class="btn btn-danger store-dashboard-review-status"
                                       title="<?= t('Decline'); ?>">
