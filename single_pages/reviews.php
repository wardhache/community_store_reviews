              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <?php for($i = 1; $i <= 5; $i++) { ?>
                    ...
                    <a href="<?= URL::to('/reviews') ?>?rm=<?= rawurlencode($encryptor->encrypt($reviewEncrypt)); ?>"><img src="<?= BASE_URL ; ?>/packages/community_store_reviews/css/images/star-small.png" alt="&#9733;" /></a>
                  <?php } ?>
                </div>
              </div>
            <?php } ?>
